...
const Contact = () => {
  ...
  return (
    <div className="contact-page">
      <section className="hero-section bg-gradient-to-r from-teal-500 to-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-6">Get in Touch</h1>
          <p className="text-xl max-w-2xl mx-auto">Have questions or want to learn more? We're here to help and would love to hear from you.</p>
        </div>
      </section>
            ...
            <div className="lg:w-1/2">
              <div className="bg-gray-100 p-8 rounded-lg h-full">
                ...
                <div className="mb-6">
                  ...
                  <p className="mb-1">123 Business Street, Suite 100</p>
      ...
      <section className="map-section py-16 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-10">Visit Us</h2>
          <div className="bg-gray-300 h-96 rounded-lg flex items-center justify-center">
            <p className="text-gray-600">Map embed would go here</p>
