...
import defimage from '../../images/girl1.jpg'
const TeamMemberCard = ({ member }) => {
  const { name, role, bio, image, department, social } = member;
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:transform hover:scale-105">
      ...
      <div className="p-4">
        ...
        <div className="flex space-x-3 mt-4">
          {social.linkedin && (
            <a href={social.linkedin} className="text-gray-400 hover:text-indigo-600" aria-label="LinkedIn">
          ...
          {social.github && (
            <a href={social.github} className="text-gray-400 hover:text-indigo-600" aria-label="GitHub">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {social.twitter && (
            <a href={social.twitter} className="text-gray-400 hover:text-indigo-600" aria-label="Twitter">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {social.dribbble && (
            <a href={social.dribbble} className="text-gray-400 hover:text-indigo-600" aria-label="Dribbble">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
